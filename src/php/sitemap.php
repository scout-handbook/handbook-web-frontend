...
$lessonList = json_decode(file_get_contents($CONFIG->{'api-uri'} . '/v0.9/lesson'), true)['response'];
$competenceList = json_decode(file_get_contents($CONFIG->{'api-uri'} . '/v0.9/competence'), true)['response'];
